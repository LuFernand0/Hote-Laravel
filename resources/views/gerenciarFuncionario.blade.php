...
<section class="container m-5">
  <div class="container m-5">
    <form >
      <div class="row center">
        <div class="col">
          <input type="text" id="marca" name="nome" class="form-control" placeholder="Digite dados do Funcionário" aria-label="First name">
        </div>
        <div class="col">
  ...
  <table class="table">
    ...
    @foreach($registrosFuncionario as $rfLoop)
      <tr>
